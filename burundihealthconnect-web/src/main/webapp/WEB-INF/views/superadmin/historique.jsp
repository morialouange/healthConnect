...
<c:set scope="request" var="pageRoute" value="superadmin-historique"/>
<fmt:setLocale value="${sessionScope.langue != null ? sessionScope.langue : 'fr'}" />
<c:set scope="request" var="pageTitre"><fmt:message key="historique.global.title"/></c:set>
<!DOCTYPE html>
...
<th scope="col"><fmt:message key="table.champ"/></th>
