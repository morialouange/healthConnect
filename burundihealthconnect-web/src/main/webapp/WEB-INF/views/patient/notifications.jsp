...
<c:set scope="request" var="pageRoute" value="patient-notifications"/>
<fmt:setLocale value="${sessionScope.langue != null ? sessionScope.langue : 'fr'}" />
<c:set scope="request" var="pageTitre"><fmt:message key="page.notifications"/></c:set>
<!DOCTYPE html>
...
<div>
<span>${n.message}</span>
<c:if test="${not n.lue}"><span><fmt:message key="badge.new"/></span></c:if>
</div>
<div>
 ${n.dateCreation}
 </div>
