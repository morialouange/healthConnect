...
<c:set scope="request" var="pageRoute" value="medecin-referenements"/>
<fmt:setLocale value="${sessionScope.langue != null ? sessionScope.langue : 'fr'}" />
<c:set scope="request" var="pageTitre"><fmt:message key="page.referenements"/></c:set>
<!DOCTYPE html>
...
<th scope="col"><fmt:message key="table.hopital_destinataire"/></th>
<th scope="col"><fmt:message key="table.motif"/></th>
<th scope="col"><fmt:message key="table.statut"/></th>
<th scope="col"><fmt:message key="table.retour"/></th>
</tr>
</thead>
<tbody>
...
<td>${r.dateRef}</td>
<td>
 ${r.consultation.dossier.patient.utilisateur.fullName}
 <c:if test="${not empty r.consultation.dossier.patient.numeroPatient}">
<span class="badge-id">${r.consultation.dossier.patient.numeroPatient}</span>
</c:if>
</td>
